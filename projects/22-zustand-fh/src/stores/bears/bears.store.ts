...
export const useBearStore = create<BearState>((set, get) => ({
  ...
  decrementBlackBears: (by: number) => set((state) => ({ blackBears: state.blackBears - by })),
  incrementPolarBears: (by: number) => set((state) => ({ polarBears: state.polarBears + by })),
  decrementPolarBears: (by: number) => set((state) => ({ polarBears: state.polarBears - by })),
  incrementPandaBears: (by: number) => set((state) => ({ pandaBears: state.pandaBears + by })),
  decrementPandaBears: (by: number) => set((state) => ({ pandaBears: state.pandaBears - by })),
  ...
  addBear: (bear: Bear) => set((state) => ({ bears: [...state.bears, bear] })),
